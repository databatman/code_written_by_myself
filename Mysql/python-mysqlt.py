...
'''将数据库的数据直接读入成dataframe'''
import pandas.io.sql as sql
con=mysql.connector.connect(host='localhost',user='root',password='1991423',database='testpandas')
cursor=con.cursor()

table_test=sql.read_sql('select * from test',con)
